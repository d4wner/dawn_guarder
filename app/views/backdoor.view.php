...
if (isset($_POST['Submit']) &&$_POST ['Submit'] == '开始') {
	#$total = 0; //文件总数
	global $total;
	global $dangerous;
...
<style type="text/css">
body {
	background: <?php echo $site_url;?>app/views/img/background5.jpg;
	color: #000;
	font-size: 12px;
}
...
<div id="top">
<h1>异常文件扫描程序</h1>
<div>本程序可以扫描指定目录的所有文件，进行<strong>异常文件查找</strong>。<br />
请不要扫描文件数太多的目录。</div>
</div>
...
<form action="<?php echo $backdoor_url;?>" name="form1"
	target="stafrm" method="post">
...
<table width="95%" border="0" align="center" cellpadding="3"
	...
	<tr>
		<td width="10%" background="<?php echo $site_url;?>app/views/img/background5.jpg"><strong>&nbsp;起始根路径：</strong></td>
		<td width="90%" background="<?php echo $site_url;?>app/views/img/background5.jpg"><input name="searchpath" type="text"
			id="searchpath" value="<?php echo dirname(__FILE__);?>" size="20" /> 点表示当前目录，末尾不要加/ </td>
	</tr>

	<tr>
		<td background="<?php echo $site_url;?>app/views/img/background5.jpg"><strong>&nbsp;文件扩展名：</strong></td>
		<td background="<?php echo $site_url;?>app/views/img/background5.jpg"><input name="shortname" type="text"
			id="shortname" size="20" value="htm|html|shtml|php" /> 多个请用|隔开</td>
	</tr>
	<tr id="rpct">
		<td height="64" colspan="2" background="<?php echo $site_url;?>app/views/img/background5.jpg">
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
			...
			<tr>
				...
				<td width="36%" colspan="3"><textarea name="sstr" id="sstr"
					style="width: 90%; height: 45px">fuck,eval,hacker,木马,大马,while(1),phpspy,aspxspy,jspspy</textarea></td>
			</tr>
		</table>
		</td>
	</tr>
...
<table width="95%" border="0" align="center" cellpadding="1"
	cellspacing="1" bgcolor="#666666">
	<tr background="<?php echo $site_url;?>app/views/img/background5.jpg">
		<td id="mtd">
