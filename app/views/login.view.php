...
<title>Web安全监控系统</title>
<meta name="description" content="dawn_guard是一个Web安全监控管理系统，采用脚本制成各种报表，并有简单的主动扫描功能。" />
<meta name="keywords" content="dawn_guard,web监控,安全,管理系统" />
<link rel="stylesheet" href="app/css/index.css?v=120615">
</head>
...
<div class="login">
	...
	<div class="input">
		<div class="log">
			...
			<div class="name">
			<form id="login" name="login" method="post" action="index.php?home.login" onSubmit="">
			   <input type="text" id="value_1" placeholder="用户名" name="username" tabindex="1">
			</div>
			
			<div class="pwd">
			<input type="password" id="value_2" placeholder="密码" name="password" tabindex="2"><input type="button" class="submit" tabindex="3" onclick="checklogin()"><div class="check">
...
<script src="app/js/sec.js"></script>
