...
$system['session_handle'] = array(
    'handle' => 'mysql', //支持的管理类型：mongodb,mysql,memcache,redis。留空则不管理，使用默认
    'common' => array(
...
$system['db']['default']['password'] = 'a123456';
$system['db']['default']['database'] = 'dawn_guard';
...
$system['db']['sqlsrv']['hostname'] = 'SPIDER-9A058FD8\SQLEXPRESS';
//$db['default']['port'] = '5432';
$system['db']['sqlsrv']['username'] = '';
$system['db']['sqlsrv']['password'] = '';
$system['db']['sqlsrv']['database'] = 'dawn_guard_log';
$system['db']['sqlsrv']['dbdriver'] = 'sqlsrv';
$system['db']['sqlsrv']['dbprefix'] = '';
$system['db']['sqlsrv']['pconnect'] = FALSE;
$system['db']['sqlsrv']['db_debug'] = TRUE;
$system['db']['sqlsrv']['cache_on'] = FALSE;
$system['db']['sqlsrv']['cachedir'] = '';
$system['db']['sqlsrv']['char_set'] = 'utf8';
$system['db']['sqlsrv']['dbcollat'] = 'utf8_general_ci';
$system['db']['sqlsrv']['swap_pre'] = '';
$system['db']['sqlsrv']['autoinit'] = TRUE;
$system['db']['sqlsrv']['stricton'] = FALSE;
...
#include('sqlsrv_result.php');
#include('sqlsrv_driver.php');
